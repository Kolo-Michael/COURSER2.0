...
export function SignupForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="signup-username" className="mb-1 block text-sm font-semibold text-slate-700 dark:text-slate-200">
          Username
        </label>
        <input
          id="signup-username"
      ...
      <p className="text-center text-xs text-slate-500 dark:text-slate-400">
        Hits <code className="rounded bg-slate-100 px-1 py-0.5 dark:bg-slate-800">/auth/signup</code> when the API is available.
      </p>
    </form>
  )
}
